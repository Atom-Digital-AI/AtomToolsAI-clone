...
import FacebookAdsTool from "../../tools/headline-tools/facebook-ads-connector/client/pages/tools/facebook-ads-looker-studio-connector";
import SeoMetaTool from "../../tools/headline-tools/seo-meta-generator/client/pages/tools/seo-meta-generator";
import GoogleAdsTool from "../../tools/headline-tools/google-ads-copy-generator/client/pages/tools/google-ads-copy-generator";
...
import FacebookAdsConnector from "../../tools/headline-tools/facebook-ads-connector/client/pages/app/facebook-ads-connector";
import GoogleAdsCopyGeneratorApp from "../../tools/headline-tools/google-ads-copy-generator/client/pages/app/google-ads-copy-generator";
import SEOMetaGeneratorApp from "../../tools/headline-tools/seo-meta-generator/client/pages/app/seo-meta-generator";
import ContentWriterV2 from "../../tools/headline-tools/content-writer-v2/client/pages/app/content-writer-v2";
