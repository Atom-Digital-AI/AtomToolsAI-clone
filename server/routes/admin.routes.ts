 ...
 */
router.get("/ai-usage-logs", requireAuth, async (req: any, res) => {
  try {
 ...
 */
router.get("/ai-usage-summary", requireAuth, async (req: any, res) => {
  try {
    const userId = req.user.id;
 ...
 */
router.get("/langgraph-metrics", requireAuth, async (req: any, res) => {
  try {
    const userId = req.user.id;
 ...
 */
router.get("/langgraph-threads", requireAuth, requireAdmin, async (req: any, res) => {
  try {
