import type { SocialContentState, WireframeOption } from "../social-content-types";
import { db } from "../../db";
...
import { validateWireframe, getTextFieldNames, extractCTAOptions } from "../../utils/ad-spec-validator";
  ...
  for (const platform of state.selectedPlatforms) {
    ...
    for (const format of formats) {
      try {
        ...
        // Build prompt
        const prompt = `You are generating social media ad wireframes. Create 3 distinct concept options (A, B, C) for the following format.
